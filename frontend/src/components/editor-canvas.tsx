      ...
      <div className="flex-1 flex items-center justify-center bg-surface-950">
        <div className="text-center">
          <div className="relative inline-block mb-6">
            <svg className="w-20 h-20 text-surface-800" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-accent-500/10 to-transparent rounded-full blur-xl" />
          </div>
          <p className="text-sm text-surface-400 mb-1">No screenshot</p>
          <p className="text-2xs text-surface-600">Capture a screenshot to start editing</p>
        </div>
      </div>
    );
  }
